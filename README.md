...
Video Demo: (https://www.youtube.com/watch?v=fKrI2kUqmok)
...
I built this project to help cut through the noisy apartment searching market and help improve my full stack development skills.
...
- Parses the websites and scrapes data to give the user recommendations down to the specific unit number.
